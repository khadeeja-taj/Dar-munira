...
export function JuzPicker({
  ...
  return (
    <div className="relative max-w-[15rem] rounded-2xl border border-leaf/40 bg-white/50 p-2.5 shadow-glass">
      <CornerVine className="pointer-events-none absolute -left-1 -top-1 h-8 w-8" />
      <CornerVine className="pointer-events-none absolute -right-1 -top-1 h-8 w-8 -scale-x-100" />
      <CornerVine className="pointer-events-none absolute -bottom-1 -left-1 h-8 w-8 -scale-y-100" />
      <CornerVine className="pointer-events-none absolute -bottom-1 -right-1 h-8 w-8 -scale-100" />
